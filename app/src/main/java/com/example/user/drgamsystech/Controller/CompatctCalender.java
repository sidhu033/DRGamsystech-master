/*
package com.example.user.drgamsystech.Controller;
...
/**
    ...
    //constructor for compatct calender
    CompatctCalender(Paint dayPaint, OverScroller scroller, Rect textSizeRect, AttributeSet attrs,
