...
public class ExpectedEarnings extends AppCompatActivity
{
    Toolbar expetoolbar;
    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_expected_earnings);

        /*Initlization*/
        expetoolbar = findViewById(R.id.expetoolbar);
        setSupportActionBar(expetoolbar);

        Drawable drawable = ContextCompat.getDrawable(getApplicationContext(),R.drawable.right_dot_menu);
        expetoolbar.setOverflowIcon(drawable);
